 ...
 * _coder_Add_info.c
 *
 * Code generation for function '_coder_Add_info'
 *
 */
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]F:/MATLAB/toolbox/eml/eml/+coder/+internal/length.m"), "resolved", 0);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("Add"));
...
/* End of code generation (_coder_Add_info.c) */
