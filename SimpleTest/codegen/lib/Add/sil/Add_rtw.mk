...
## 
## Makefile     : Add_rtw.mk
## Generated on : Fri Nov 13 04:26:07 2015
...
MODELREF_LIBS = $(START_DIR)\codegen\lib\Add\Add.lib
...
{$(START_DIR)\codegen\lib\Add}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\Add}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\Add\sil}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\Add\sil}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
