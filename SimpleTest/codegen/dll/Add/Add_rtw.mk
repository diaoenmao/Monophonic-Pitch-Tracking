...
## 
## Makefile     : Add_rtw.mk
## Generated on : Fri Nov 13 04:26:58 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Add.dll
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Add.dll
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\codegen\dll\Add;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\codegen\dll\Add\Add_initialize.c $(START_DIR)\codegen\dll\Add\Add_terminate.c $(START_DIR)\codegen\dll\Add\Add.c $(START_DIR)\codegen\dll\Add\rt_nonfinite.c $(START_DIR)\codegen\dll\Add\rtGetNaN.c $(START_DIR)\codegen\dll\Add\rtGetInf.c
...
OBJS = Add_initialize.obj Add_terminate.obj Add.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
