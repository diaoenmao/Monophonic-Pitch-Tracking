...
## 
## Makefile     : Add_rtw.mk
## Generated on : Fri Nov 13 04:27:06 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: Add.exe
...
DEFINES_OPTS = -DCS_SUPPORTS_WORD_ADDRESSABLE_TARGETS=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
...
SRCS = $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\xil_interface_lib.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\xilcomms_rtiostream.c $(START_DIR)\codegen\dll\Add\sil\xil_interface.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\xil_data_stream.c $(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\sil_main.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\target_io.c $(MATLAB_ROOT)\rtw\c\src\rtiostream\rtiostreamtcpip\rtiostream_tcpip.c
...
OBJS = xil_interface_lib.obj xilcomms_rtiostream.obj xil_interface.obj xil_data_stream.obj rtiostream_utils.obj sil_main.obj target_io.obj rtiostream_tcpip.obj
...
MODELREF_LIBS = $(START_DIR)\codegen\dll\Add\Add.lib
...
{$(START_DIR)\codegen\dll\Add}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\dll\Add}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\dll\Add\sil}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\dll\Add\sil}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
