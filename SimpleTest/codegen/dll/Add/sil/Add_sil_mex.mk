...
SYS_INCLUDE += /I "$(START_DIR)\codegen\dll\Add\interface"
SYS_INCLUDE += /I "..\."
...
%.$(OBJEXT) : $(START_DIR)\codegen\dll\Add\interface/%.c
	$(CC) $(CFLAGS) "$<"

%.$(OBJEXT) : $(START_DIR)\codegen\dll\Add\sil/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\dll\Add\interface/%.cpp
	$(CC) $(CPPFLAGS) "$<"

%.$(OBJEXT) : $(START_DIR)\codegen\dll\Add\sil/%.cpp
	$(CC) $(CPPFLAGS) "$<"
