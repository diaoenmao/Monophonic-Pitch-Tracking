...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\Add"
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\Add\interface"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Add/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Add/%.cpp
	$(CC) $(CPPFLAGS) "$<"
