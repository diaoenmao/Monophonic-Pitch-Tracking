function [totalMatch, pitchMatch, unpitchMatch] = evalChromaAccuracy(extracted, reference);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [totalMatch, pitchMatch, unpitchMatch] = evalChromaAccuracy(extracted, reference)
