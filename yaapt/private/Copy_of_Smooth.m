...
while(1)
    ...
    elseif(check_idx==length(headidx))
    ...
    %Smooth Criteria
    if(check_pitch ~= 0)
        if(left_pitch==0 && right_pitch == 0)
            if(check_pitchlength<min_length)
        ...
        elseif(left_pitch ~= 0 && right_pitch == 0)
        ...
        elseif(left_pitch == 0 && right_pitch ~= 0)
            if(((check_pitchlength/right_pitchlength<absorb_threshold)||check_pitchlength<min_length)&&check_pitchlength<stable_length)
