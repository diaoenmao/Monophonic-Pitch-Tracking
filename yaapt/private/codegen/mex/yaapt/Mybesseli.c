...
static emlrtRSInfo bf_emlrtRSI = { 84, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo cf_emlrtRSI = { 85, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo df_emlrtRSI = { 99, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo ef_emlrtRSI = { 100, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo ff_emlrtRSI = { 102, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo gf_emlrtRSI = { 116, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo hf_emlrtRSI = { 118, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo if_emlrtRSI = { 190, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo jf_emlrtRSI = { 197, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo kf_emlrtRSI = { 201, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo lf_emlrtRSI = { 238, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo mf_emlrtRSI = { 242, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo nf_emlrtRSI = { 313, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo of_emlrtRSI = { 315, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo pf_emlrtRSI = { 321, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo qf_emlrtRSI = { 322, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo rf_emlrtRSI = { 349, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo sf_emlrtRSI = { 350, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo tf_emlrtRSI = { 361, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };

static emlrtRSInfo uf_emlrtRSI = { 234, "find",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m" };

static emlrtRSInfo xf_emlrtRSI = { 39, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };

static emlrtRSInfo yf_emlrtRSI = { 50, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };

static emlrtRSInfo ag_emlrtRSI = { 53, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };

static emlrtRSInfo bg_emlrtRSI = { 100, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };

static emlrtRSInfo cg_emlrtRSI = { 123, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };
...
static emlrtRTEInfo ie_emlrtRTEI = { 63, 15, "reshape",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\reshape.m" };

static emlrtRTEInfo je_emlrtRTEI = { 243, 9, "find",
  "F:\\Matlab2015b\\toolbox\\eml\\lib\\matlab\\elmat\\find.m" };
...
static emlrtRTEInfo me_emlrtRTEI = { 231, 13, "Mybesseli",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\Mybesseli.m" };
               ...
               *output)
{
  ...
  i17 = b->size[0];
  b->size[0] = xx->size[0];
  emxEnsureCapacity(sp, (emxArray__common *)b, i17, (int32_T)sizeof(real_T),
                    &jb_emlrtRTEI);
  nx = xx->size[0];
  ...
  i17 = xx->size[0];
  xx->size[0] = ixstart;
  emxEnsureCapacity(sp, (emxArray__common *)xx, i17, (int32_T)sizeof(real_T),
                    &jb_emlrtRTEI);
  ...
  if (idx <= x->size[0]) {
    ...
    emlrtErrorWithMessageIdR2012b(&b_st, &je_emlrtRTEI,
  ...
  i17 = v->size[0];
  v->size[0] = ii->size[0];
  emxEnsureCapacity(&st, (emxArray__common *)v, i17, (int32_T)sizeof(real_T),
                    &jb_emlrtRTEI);
  nx = ii->size[0];
  for (i17 = 0; i17 < nx; i17++) {
    v->data[i17] = ii->data[i17];
  }
  ...
  if (b_any(&st, v)) {
    ...
    i17 = ii->size[0];
    ii->size[0] = v->size[0];
    emxEnsureCapacity(sp, (emxArray__common *)ii, i17, (int32_T)sizeof(int32_T),
                      &jb_emlrtRTEI);
    nx = v->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      idx = (int32_T)v->data[i17];
    ...
    emxEnsureCapacity(sp, (emxArray__common *)tempc, i17, (int32_T)sizeof(real_T),
                      &jb_emlrtRTEI);
    nx = v->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      tempc->data[i17] = rtInf;
    }
    ...
    nx = tempc->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      b->data[ii->data[i17]] = tempc->data[i17];
    }
  }
  ...
  i17 = x->size[0];
  x->size[0] = xx->size[0];
  emxEnsureCapacity(sp, (emxArray__common *)x, i17, (int32_T)sizeof(boolean_T),
                    &jb_emlrtRTEI);
  nx = xx->size[0];
  for (i17 = 0; i17 < nx; i17++) {
    x->data[i17] = (0.0001 <= xx->data[i17]);
  }

  emxInit_boolean_T1(sp, &r7, 1, &jb_emlrtRTEI, true);
  i17 = r7->size[0];
  r7->size[0] = xx->size[0];
  emxEnsureCapacity(sp, (emxArray__common *)r7, i17, (int32_T)sizeof(boolean_T),
                    &jb_emlrtRTEI);
  nx = xx->size[0];
  for (i17 = 0; i17 < nx; i17++) {
    r7->data[i17] = (xx->data[i17] <= 1000.0);
  }

  i17 = x->size[0];
  idx = r7->size[0];
  if (i17 != idx) {
    emlrtSizeEqCheck1DR2012b(i17, idx, &eb_emlrtECI, sp);
  }
  ...
  nx = x->size[0];
  for (i17 = 0; i17 < nx; i17++) {
    x->data[i17] = (x->data[i17] && r7->data[i17]);
  }
  ...
  if (b_any(&st, v)) {
    ...
    i17 = a->size[0];
    a->size[0] = p->size[0];
    emxEnsureCapacity(sp, (emxArray__common *)a, i17, (int32_T)sizeof(real_T),
                      &jb_emlrtRTEI);
    nx = p->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      a->data[i17] = p->data[i17];
    }
    ...
    do {
      ...
      i17 = b_p->size[0];
      b_p->size[0] = p->size[0];
      emxEnsureCapacity(sp, (emxArray__common *)b_p, i17, (int32_T)sizeof
                        (boolean_T), &jb_emlrtRTEI);
      nx = p->size[0];
      for (i17 = 0; i17 < nx; i17++) {
        b_p->data[i17] = (p->data[i17] < test);
      }
      ...
      if (c_any(&st, b_p)) {
        ...
        if (count == 1) {
          ...
          emxEnsureCapacity(sp, (emxArray__common *)tempc, i17, (int32_T)sizeof
                            (real_T), &jb_emlrtRTEI);
          nx = a->size[0];
          for (i17 = 0; i17 < nx; i17++) {
            tempc->data[i17] = a->data[i17];
          }

          /* 'Mybesseli:196' a = p; */
          i17 = a->size[0];
          a->size[0] = p->size[0];
          emxEnsureCapacity(sp, (emxArray__common *)a, i17, (int32_T)sizeof
                            (real_T), &jb_emlrtRTEI);
          nx = p->size[0];
          for (i17 = 0; i17 < nx; i17++) {
            a->data[i17] = p->data[i17];
          ...
          emxEnsureCapacity(sp, (emxArray__common *)c_en, i17, (int32_T)sizeof
                            (real_T), &jb_emlrtRTEI);
          nx = p->size[0];
          for (i17 = 0; i17 < nx; i17++) {
            c_en->data[i17] = en * p->data[i17];
          }

          st.site = &jf_emlrtRSI;
          d_rdivide(&st, c_en, b_x, p);
          i17 = p->size[0];
          idx = tempc->size[0];
          if (i17 != idx) {
            emlrtSizeEqCheck1DR2012b(i17, idx, &db_emlrtECI, sp);
          }

          i17 = p->size[0];
          emxEnsureCapacity(sp, (emxArray__common *)p, i17, (int32_T)sizeof
                            (real_T), &jb_emlrtRTEI);
          nx = p->size[0];
          for (i17 = 0; i17 < nx; i17++) {
            p->data[i17] += tempc->data[i17];
          }
        } else {
          /* 'Mybesseli:198' else */
          ...
          emxEnsureCapacity(sp, (emxArray__common *)b_en, i17, (int32_T)sizeof
                            (real_T), &jb_emlrtRTEI);
          nx = p->size[0];
          for (i17 = 0; i17 < nx; i17++) {
            b_en->data[i17] = en * p->data[i17];
          }

          st.site = &kf_emlrtRSI;
          d_rdivide(&st, b_en, b_x, tempc);
          ixstart = p->size[0];
          i17 = tempc->size[0];
          if (i17 != ixstart) {
            emlrtSizeEqCheck1DR2012b(i17, ixstart, &cb_emlrtECI, sp);
          }
    ...
    emxEnsureCapacity(sp, (emxArray__common *)b_tempa, i17, (int32_T)sizeof
                      (real_T), &jb_emlrtRTEI);
    nx = tempa->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      b_tempa->data[i17] = tempa->data[i17] * (n - 1.0) * ((n - 1.0) - 1.0);
    }
    ...
    if (n - 1.0 < 0.0) {
      ...
      i17 = (int32_T)n;
      if (!((i17 >= 1) && (i17 <= 1))) {
        emlrtDynamicBoundsCheckR2012b(i17, 1, 1, &fc_emlrtBCI, sp);
      }
      ...
      nx = tempa->size[0];
      for (i17 = 0; i17 < nx; i17++) {
        b->data[ii->data[i17]] = tempa->data[i17];
      }
      ...
      i17 = r8->size[0];
      r8->size[0] = 0;
      emxEnsureCapacity(sp, (emxArray__common *)r8, i17, (int32_T)sizeof(int32_T),
                        &jb_emlrtRTEI);
      d_ii[0] = ii->size[0];
      d_ii[1] = 0;
      b_v[0] = v->size[0];
      ...
      if (n - 1.0 > 0.0) {
        ...
        emxEnsureCapacity(sp, (emxArray__common *)p, i17, (int32_T)sizeof(real_T),
                          &jb_emlrtRTEI);
        nx = tempa->size[0];
        for (i17 = 0; i17 < nx; i17++) {
          p->data[i17] = tempa->data[i17];
        }
        ...
        while ((!exitg3) && (l <= (int32_T)nend - 1)) {
          ...
          if (count2 == 1) {
            ...
            emxEnsureCapacity(sp, (emxArray__common *)tempc, i17, (int32_T)
                              sizeof(real_T), &jb_emlrtRTEI);
            nx = p->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              tempc->data[i17] = p->data[i17];
            }
            ...
            emxEnsureCapacity(sp, (emxArray__common *)e_en, i17, (int32_T)sizeof
                              (real_T), &jb_emlrtRTEI);
            nx = tempa->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              e_en->data[i17] = en * tempa->data[i17];
            }

            st.site = &lf_emlrtRSI;
            d_rdivide(&st, e_en, b_x, tempa);
            i17 = tempa->size[0];
            idx = tempc->size[0];
            if (i17 != idx) {
              emlrtSizeEqCheck1DR2012b(i17, idx, &bb_emlrtECI, sp);
            }

            i17 = tempa->size[0];
            emxEnsureCapacity(sp, (emxArray__common *)tempa, i17, (int32_T)
                              sizeof(real_T), &jb_emlrtRTEI);
            nx = tempa->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              tempa->data[i17] += tempc->data[i17];
            }
          } else {
            /* 'Mybesseli:239' else */
            ...
            emxEnsureCapacity(sp, (emxArray__common *)d_en, i17, (int32_T)sizeof
                              (real_T), &jb_emlrtRTEI);
            nx = tempa->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              d_en->data[i17] = en * tempa->data[i17];
            }

            st.site = &mf_emlrtRSI;
            d_rdivide(&st, d_en, b_x, tempa);
          }
          ...
          if (n == 1.0) {
            ...
            nx = tempa->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              tempc->data[i17] = tempa->data[i17] * empal;
            }

            i17 = a->size[0];
            idx = tempc->size[0];
            if (i17 != idx) {
              emlrtSizeEqCheck1DR2012b(i17, idx, &ab_emlrtECI, sp);
            }

            i17 = b_a->size[0];
            b_a->size[0] = a->size[0];
            emxEnsureCapacity(sp, (emxArray__common *)b_a, i17, (int32_T)sizeof
                              (real_T), &jb_emlrtRTEI);
            nx = a->size[0];
            for (i17 = 0; i17 < nx; i17++) {
              b_a->data[i17] = (a->data[i17] + tempc->data[i17]) * emp2al;
            }
      ...
      i17 = (int32_T)n;
      if (!((i17 >= 1) && (i17 <= 1))) {
        emlrtDynamicBoundsCheckR2012b(i17, 1, 1, &ec_emlrtBCI, sp);
      }
      ...
      idx = tempa->size[0];
      if (i17 != idx) {
        emlrtSizeEqCheck1DR2012b(i17, idx, &y_emlrtECI, sp);
      }
      ...
      nx = a->size[0];
      for (i17 = 0; i17 < nx; i17++) {
        a->data[i17] = (a->data[i17] + a->data[i17]) + tempa->data[i17];
      }
    ...
    idx = b_x->size[0];
    if (i17 != idx) {
      emlrtSizeEqCheck1DR2012b(i17, idx, &t_emlrtECI, sp);
    }
    ...
    i17 = b_b->size[0];
    b_b->size[0] = v->size[0];
    emxEnsureCapacity(sp, (emxArray__common *)b_b, i17, (int32_T)sizeof(real_T),
                      &jb_emlrtRTEI);
    nx = v->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      idx = (int32_T)v->data[i17];
      ...
      b_b->data[i17] = b->data[idx - 1];
    }

    st.site = &of_emlrtRSI;
    d_rdivide(&st, b_b, a, tempc);
    e_ii[0] = ii->size[0];
  ...
  nx = xx->size[0];
  for (i17 = 0; i17 < nx; i17++) {
    r7->data[i17] = (xx->data[i17] < 0.0001);
  }

  i17 = x->size[0];
  idx = r7->size[0];
  if (i17 != idx) {
    emlrtSizeEqCheck1DR2012b(i17, idx, &r_emlrtECI, sp);
  }
  ...
  if (b_any(&st, v)) {
    ...
    nx = v->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      tempc->data[i17] = 0.5 * xx->data[(int32_T)v->data[i17] - 1];
    }
    ...
    i17 = tempc->size[0];
    if (ixstart != i17) {
      emlrtSizeEqCheck1DR2012b(ixstart, i17, &q_emlrtECI, sp);
    }

    i17 = r9->size[0];
    r9->size[0] = tempc->size[0];
    emxEnsureCapacity(sp, (emxArray__common *)r9, i17, (int32_T)sizeof(real_T),
                      &jb_emlrtRTEI);
    nx = tempc->size[0];
    for (i17 = 0; i17 < nx; i17++) {
      r9->data[i17] = tempc->data[i17];
    }
    ...
    i17 = tempc->size[0];
    if (ixstart != i17) {
      emlrtSizeEqCheck1DR2012b(ixstart, i17, &p_emlrtECI, sp);
    }
    ...
    for (i17 = 0; i17 < ixstart; i17++) {
      b->data[ii->data[i17]] = 1.0 + tempc->data[i17];
    }
  ...
  i17 = c_b->size[0];
  c_b->size[0] = ixstart;
  emxEnsureCapacity(sp, (emxArray__common *)c_b, i17, (int32_T)sizeof(real_T),
                    &jb_emlrtRTEI);
  for (i17 = 0; i17 < ixstart; i17++) {
    c_b->data[i17] = b->data[i17];
  }
  ...
  i17 = output->size[0] * output->size[1];
  output->size[0] = nx;
  output->size[1] = 1;
  emxEnsureCapacity(&st, (emxArray__common *)output, i17, (int32_T)sizeof(real_T),
                    &jb_emlrtRTEI);
  if (b->size[0] == output->size[0]) {
  } else {
    emlrtErrorWithMessageIdR2012b(&st, &ie_emlrtRTEI,
...
real_T b_Mybesseli(const emlrtStack *sp)
{
  ...
  i20 = (int32_T)n;
  if (!((i20 >= 1) && (i20 <= 1))) {
    emlrtDynamicBoundsCheckR2012b(i20, 1, 1, &ec_emlrtBCI, sp);
  }
