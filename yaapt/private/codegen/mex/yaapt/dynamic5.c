...
static emlrtRSInfo dm_emlrtRSI = { 58, "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m" };

static emlrtRTEInfo md_emlrtRTEI = { 1, 23, "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m" };

static emlrtRTEInfo nd_emlrtRTEI = { 40, 1, "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m" };

static emlrtRTEInfo od_emlrtRTEI = { 58, 1, "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m" };

static emlrtBCInfo sf_emlrtBCI = { -1, -1, 48, 46, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo tf_emlrtBCI = { -1, -1, 48, 48, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo uf_emlrtBCI = { -1, -1, 48, 65, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo vf_emlrtBCI = { -1, -1, 48, 67, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo wf_emlrtBCI = { -1, -1, 64, 31, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtDCInfo dd_emlrtDCI = { 64, 31, "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 1 };

static emlrtBCInfo xf_emlrtBCI = { -1, -1, 64, 31, "Path", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo yf_emlrtBCI = { -1, -1, 64, 40, "Pitch_array", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo ag_emlrtBCI = { -1, -1, 64, 5, "FinPitch", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo bg_emlrtBCI = { -1, -1, 48, 19, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo cg_emlrtBCI = { -1, -1, 48, 21, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo dg_emlrtBCI = { -1, -1, 48, 23, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo eg_emlrtBCI = { -1, -1, 49, 40, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo fg_emlrtBCI = { -1, -1, 49, 42, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo gg_emlrtBCI = { -1, -1, 49, 44, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo hg_emlrtBCI = { -1, -1, 49, 55, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo ig_emlrtBCI = { -1, -1, 49, 57, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo jg_emlrtBCI = { -1, -1, 49, 59, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo kg_emlrtBCI = { -1, -1, 49, 19, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo lg_emlrtBCI = { -1, -1, 49, 21, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };

static emlrtBCInfo mg_emlrtBCI = { -1, -1, 49, 23, "Trans", "dynamic5",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\dynamic5.m", 0 };
              ...
              emxArray_real_T *Merit_array, real_T k1, emxArray_real_T *FinPitch)
{
  ...
  emxInit_real_T2(sp, &Trans, 3, &nd_emlrtRTEI, true);
    ...
    while (j - 1 <= numcands) {
      ...
      while (k - 1 <= numcands) {
        ...
        if (!((loop_ub >= 1) && (loop_ub <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(loop_ub, 1, b_Trans, &sf_emlrtBCI, sp);
        }
        ...
        if (!((k >= 1) && (k <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_Trans, &bg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[1];
        if (!((j >= 1) && (j <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(j, 1, b_Trans, &cg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[2];
        if (!((i + 2 >= 1) && (i + 2 <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(i + 2, 1, b_Trans, &dg_emlrtBCI, sp);
        }
        ...
        b_Trans = Trans->size[0];
        if (!((k >= 1) && (k <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_Trans, &eg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[1];
        if (!((j >= 1) && (j <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(j, 1, b_Trans, &fg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[2];
        if (!((i + 2 >= 1) && (i + 2 <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(i + 2, 1, b_Trans, &gg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[0];
        if (!((k >= 1) && (k <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_Trans, &hg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[1];
        if (!((j >= 1) && (j <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(j, 1, b_Trans, &ig_emlrtBCI, sp);
        }

        b_Trans = Trans->size[2];
        if (!((i + 2 >= 1) && (i + 2 <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(i + 2, 1, b_Trans, &jg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[0];
        if (!((k >= 1) && (k <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_Trans, &kg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[1];
        if (!((j >= 1) && (j <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(j, 1, b_Trans, &lg_emlrtBCI, sp);
        }

        b_Trans = Trans->size[2];
        if (!((i + 2 >= 1) && (i + 2 <= b_Trans))) {
          emlrtDynamicBoundsCheckR2012b(i + 2, 1, b_Trans, &mg_emlrtBCI, sp);
        }
  ...
  emxInit_real_T(sp, &r32, 2, &md_emlrtRTEI, true);

  /*  search the best path */
  /* 'dynamic5:58' Path = path1(Local, Trans); */
  b_Trans = r32->size[0] * r32->size[1];
  r32->size[0] = Merit_array->size[0];
  r32->size[1] = Merit_array->size[1];
  emxEnsureCapacity(sp, (emxArray__common *)r32, b_Trans, (int32_T)sizeof(real_T),
                    &md_emlrtRTEI);
  loop_ub = Merit_array->size[0] * Merit_array->size[1];
  for (b_Trans = 0; b_Trans < loop_ub; b_Trans++) {
    r32->data[b_Trans] = 1.0 - Merit_array->data[b_Trans];
  }

  emxInit_real_T(sp, &Path, 2, &od_emlrtRTEI, true);
  st.site = &dm_emlrtRSI;
  path1(&st, r32, Trans, Path);
  ...
  while (n - 1 <= numframes) {
    ...
    loop_ub = Path->size[1];
    if (!((n >= 1) && (n <= loop_ub))) {
      emlrtDynamicBoundsCheckR2012b(n, 1, loop_ub, &xf_emlrtBCI, sp);
    }

    d0 = Path->data[n - 1];
    if (d0 != (int32_T)muDoubleScalarFloor(d0)) {
      emlrtIntegerCheckR2012b(d0, &dd_emlrtDCI, sp);
    }
    ...
    b_Trans = Pitch_array->size[1];
    if (!((n >= 1) && (n <= b_Trans))) {
      emlrtDynamicBoundsCheckR2012b(n, 1, b_Trans, &yf_emlrtBCI, sp);
    }
