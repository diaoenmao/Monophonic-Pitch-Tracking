...
static emlrtRSInfo wc_emlrtRSI = { 55, "xgetrf",
  "F:\\MATLAB\\R2016a\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgetrf.m"
};

static emlrtRTEInfo bb_emlrtRTEI = { 1, 26, "xgetrf",
  "F:\\MATLAB\\R2016a\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgetrf.m"
};

static emlrtRTEInfo bf_emlrtRTEI = { 55, 5, "xgetrf",
  "F:\\MATLAB\\R2016a\\toolbox\\eml\\eml\\+coder\\+internal\\+lapack\\xgetrf.m"
};
            ...
            int32_T lda, emxArray_int32_T *ipiv, int32_T *info)
{
  ...
  if ((A->size[0] == 0) || (A->size[1] == 0)) {
    ...
    emxInit_ptrdiff_t(&b_st, &ipiv_t, 1, &bf_emlrtRTEI, true);
    k = ipiv_t->size[0];
    ipiv_t->size[0] = NPIV;
