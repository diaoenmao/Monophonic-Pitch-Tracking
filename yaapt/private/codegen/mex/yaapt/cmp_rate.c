...
static emlrtRSInfo ak_emlrtRSI = { 69, "cmp_rate",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\cmp_rate.m" };

static emlrtRSInfo bk_emlrtRSI = { 93, "cmp_rate",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\cmp_rate.m" };

static emlrtRSInfo ck_emlrtRSI = { 115, "cmp_rate",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\cmp_rate.m" };
              ...
              emxArray_real_T *Merit)
{
  ...
  i36 = (int32_T)(lag_max + (1.0 - (lag_min - 3.0)));
  emlrtForLoopVectorCheckR2012b(lag_min - 3.0, 1.0, lag_max, mxDOUBLE_CLASS, i36,
    &mf_emlrtRTEI, sp);
  n = 0;
  exitg2 = false;
  while ((!exitg2) && (n <= i36 - 1)) {
    ...
    if (b_n > (b_n + 5.0) - 1.0) {
      ...
      i37 = (int32_T)b_n;
      if (!((i37 >= 1) && (i37 <= i38))) {
        emlrtDynamicBoundsCheckR2012b(i37, 1, i38, &ff_emlrtBCI, sp);
      }

      i38 = Phi->size[1];
      ixstart = (int32_T)((uint32_T)b_n + 4U);
      if (!((ixstart >= 1) && (ixstart <= i38))) {
        emlrtDynamicBoundsCheckR2012b(ixstart, 1, i38, &ff_emlrtBCI, sp);
      }
    ...
    if (i38 - i37 > 1) {
      if (muDoubleScalarIsNaN(mtmp)) {
        ...
        while ((!exitg3) && (ix <= c_n)) {
          ixstart = ix + 1;
          if (!muDoubleScalarIsNaN(Phi->data[(i37 + ix) - 2])) {
            mtmp = Phi->data[(i37 + ix) - 2];
            itmp = ix;
            exitg3 = true;
          } else {
            ix++;
      ...
      if (ixstart - 1 < i38 - i37) {
        e_st.site = &ib_emlrtRSI;
        if (ixstart > i38 - i37) {
          b_ixstart = false;
        } else {
          b_ixstart = (i38 - i37 > 2147483646);
        }
        ...
        while (ixstart <= c_n) {
          if (Phi->data[(i37 + ixstart) - 2] > mtmp) {
            mtmp = Phi->data[(i37 + ixstart) - 2];
            itmp = ixstart;
          }
  ...
  for (i36 = 0; i36 < 20; i36++) {
    if (!((iidx[i36] >= 1) && (iidx[i36] <= 20))) {
      emlrtDynamicBoundsCheckR2012b(iidx[i36], 1, 20, &hf_emlrtBCI, sp);
    }

    c_Pitch[i36] = b_Pitch[iidx[i36] - 1];
  }
  ...
  i36 = Merit->size[0] * Merit->size[1];
  Merit->size[0] = 1;
  Merit->size[1] = ixstart;
  emxEnsureCapacity(sp, (emxArray__common *)Merit, i36, (int32_T)sizeof(real_T),
                    &bd_emlrtRTEI);
  for (i36 = 0; i36 < ixstart; i36++) {
    Merit->data[Merit->size[0] * i36] = b_Merit[i36];
  }
  ...
  i36 = Pitch->size[0] * Pitch->size[1];
  Pitch->size[0] = 1;
  Pitch->size[1] = ixstart;
  emxEnsureCapacity(sp, (emxArray__common *)Pitch, i36, (int32_T)sizeof(real_T),
                    &bd_emlrtRTEI);
  for (i36 = 0; i36 < ixstart; i36++) {
    Pitch->data[Pitch->size[0] * i36] = b_Pitch[i36];
  }
  ...
  if (numpeaks < 3) {
    ...
    if (ixstart == 0) {
      ...
      Pitch->size[0] = 1;
      Pitch->size[1] = 3;
      emxEnsureCapacity(sp, (emxArray__common *)Pitch, i36, (int32_T)sizeof
                        (real_T), &bd_emlrtRTEI);
      for (i36 = 0; i36 < 3; i36++) {
        Pitch->data[i36] = 0.0;
      }
      ...
      Merit->size[0] = 1;
      Merit->size[1] = 3;
      emxEnsureCapacity(sp, (emxArray__common *)Merit, i36, (int32_T)sizeof
                        (real_T), &bd_emlrtRTEI);
      for (i36 = 0; i36 < 3; i36++) {
        Merit->data[i36] = 0.001;
      }
    } else {
      ...
      emxEnsureCapacity(sp, (emxArray__common *)Pitch, i36, (int32_T)sizeof
                        (real_T), &bd_emlrtRTEI);
      itmp = 3 - numpeaks;
      i36 = r22->size[0] * r22->size[1];
      r22->size[0] = 1;
      r22->size[1] = itmp;
      emxEnsureCapacity(sp, (emxArray__common *)r22, i36, (int32_T)sizeof(real_T),
                        &bd_emlrtRTEI);
      for (i36 = 0; i36 < itmp; i36++) {
        r22->data[r22->size[0] * i36] = 0.0;
      }

      for (i36 = 0; i36 < c_n; i36++) {
        Pitch->data[ixstart + i36] = r22->data[i36];
      }
      ...
      emxEnsureCapacity(sp, (emxArray__common *)r23, i36, (int32_T)sizeof(real_T),
                        &bd_emlrtRTEI);
      ixstart = 3 - numpeaks;
      for (i36 = 0; i36 < ixstart; i36++) {
        r23->data[i36] = 0.001;
      ...
      r24->size[0] = 1;
      r24->size[1] = itmp;
      emxEnsureCapacity(sp, (emxArray__common *)r24, i36, (int32_T)sizeof(real_T),
                        &bd_emlrtRTEI);
      emxFree_real_T(&r23);
      for (i36 = 0; i36 < itmp; i36++) {
        r24->data[r24->size[0] * i36] = 0.001;
      }

      for (i36 = 0; i36 < c_n; i36++) {
        Merit->data[ixstart + i36] = r24->data[i36];
      }
  ...
  if (mtmp > 1.0) {
    ...
    i36 = c_Merit->size[0] * c_Merit->size[1];
    c_Merit->size[0] = 1;
    c_Merit->size[1] = Merit->size[1];
    emxEnsureCapacity(sp, (emxArray__common *)c_Merit, i36, (int32_T)sizeof
                      (real_T), &bd_emlrtRTEI);
    ixstart = Merit->size[0] * Merit->size[1];
    for (i36 = 0; i36 < ixstart; i36++) {
      c_Merit->data[i36] = Merit->data[i36];
    }
