...
static emlrtRTEInfo v_emlrtRTEI = { 187, 13, "find",
  "F:\\MATLAB\\toolbox\\eml\\lib\\matlab\\elmat\\find.m" };

static emlrtRTEInfo w_emlrtRTEI = { 188, 13, "find",
  "F:\\MATLAB\\toolbox\\eml\\lib\\matlab\\elmat\\find.m" };

static emlrtRTEInfo x_emlrtRTEI = { 68, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo y_emlrtRTEI = { 69, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo ab_emlrtRTEI = { 77, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo bb_emlrtRTEI = { 79, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo cb_emlrtRTEI = { 81, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo db_emlrtRTEI = { 82, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo eb_emlrtRTEI = { 87, 9, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo fb_emlrtRTEI = { 90, 14, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo gb_emlrtRTEI = { 140, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo hb_emlrtRTEI = { 151, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };

static emlrtRTEInfo ib_emlrtRTEI = { 156, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };
...
static emlrtRTEInfo le_emlrtRTEI = { 84, 1, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };
...
static emlrtRTEInfo me_emlrtRTEI = { 93, 9, "spec_trk",
  "D:\\GitHub\\Monophonic-Pitch-Tracking\\yaapt\\private\\spec_trk.m" };
              ...
              emxArray_real_T *pStd)
{
  ...
  emxInit_real_T(sp, &CandsPitch, 2, &x_emlrtRTEI, true);
  ...
  emxInit_real_T(sp, &Kaiser_window, 2, &ab_emlrtRTEI, true);
  emxInit_real_T(sp, &SHC, 2, &bb_emlrtRTEI, true);
  ...
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, numframes, mxDOUBLE_CLASS, (int32_T)
    numframes, &le_emlrtRTEI, sp);
  frame = 0;
  emxInit_real_T(sp, &Signal, 2, &eb_emlrtRTEI, true);
  emxInit_real_T1(sp, &Magnit, 1, &fb_emlrtRTEI, true);
  emxInit_real_T(sp, &r6, 2, &u_emlrtRTEI, true);
  emxInit_real_T(sp, &b_SHC, 2, &u_emlrtRTEI, true);
  emxInit_real_T(sp, &b_Magnit, 2, &u_emlrtRTEI, true);
  ...
  n = 1;
  emxInit_int32_T(sp, &d_iindx, 1, &u_emlrtRTEI, true);
  emxInit_int32_T(sp, &e_iindx, 1, &u_emlrtRTEI, true);
  ...
  emxInit_boolean_T1(sp, &c_SPitch, 1, &u_emlrtRTEI, true);
  ...
  emxInit_boolean_T1(sp, &b_SPitch_temp_end, 1, &u_emlrtRTEI, true);
