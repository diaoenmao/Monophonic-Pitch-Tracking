...
static emlrtRTEInfo xd_emlrtRTEI = { 17, 9, "error",
...
{
  emlrtErrorWithMessageIdR2012b(sp, &xd_emlrtRTEI, "MATLAB:nomem", 0);
}
...
{
  emlrtErrorWithMessageIdR2012b(sp, &xd_emlrtRTEI, "MATLAB:interp1:NaNinX", 0);
}
