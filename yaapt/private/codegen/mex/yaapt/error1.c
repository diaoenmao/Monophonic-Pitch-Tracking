...
static emlrtRTEInfo rd_emlrtRTEI = { 17, 9, "error",
  "F:\\Matlab2015b\\toolbox\\eml\\eml\\+coder\\+internal\\error.m" };
...
{
  emlrtErrorWithMessageIdR2012b(sp, &rd_emlrtRTEI, "MATLAB:nomem", 0);
}
