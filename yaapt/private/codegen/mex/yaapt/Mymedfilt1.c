...
void Mymedfilt1(const emlrtStack *sp, emxArray_real_T *s, emxArray_real_T *m)
{
  ...
  s->size[0] = 1;
  s->size[1] = b_s->size[1];
  emxEnsureCapacity(sp, (emxArray__common *)s, i27, (int32_T)sizeof(real_T),
                    &xb_emlrtRTEI);
  loop_ub = b_s->size[1];
  for (i27 = 0; i27 < loop_ub; i27++) {
    s->data[s->size[0] * i27] = b_s->data[b_s->size[0] * i27];
  }
  ...
  i27 = s->size[1];
  if (!(1 <= i27)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i27, &pd_emlrtBCI, sp);
  }
  ...
  i28 = s->size[1];
  if (!((i28 >= 1) && (i28 <= i27))) {
    emlrtDynamicBoundsCheckR2012b(i28, 1, i27, &qd_emlrtBCI, sp);
  }
  ...
  while (i < 5) {
    ...
    i27 = r15->size[0];
    r15->size[0] = loop_ub;
    emxEnsureCapacity(sp, (emxArray__common *)r15, i27, (int32_T)sizeof(int32_T),
                      &xb_emlrtRTEI);
    for (i27 = 0; i27 < loop_ub; i27++) {
      r15->data[i27] = i27;
    }
    ...
    emxEnsureCapacity(sp, (emxArray__common *)r16, i27, (int32_T)sizeof(real_T),
                      &xb_emlrtRTEI);
    for (i27 = 0; i27 < i; i27++) {
      r16->data[r16->size[0] * i27] = d_s;
    }

    loop_ub = s->size[1];
    for (i27 = 0; i27 < loop_ub; i27++) {
      r16->data[r16->size[0] * (i27 + i)] = s->data[s->size[0] * i27];
    }

    for (i27 = 0; i27 < c_s; i27++) {
      r16->data[r16->size[0] * ((i27 + i) + s->size[1])] = e_s;
    }
    ...
    loop_ub = r16->size[1];
    for (i27 = 0; i27 < loop_ub; i27++) {
      b_m->data[i + b_m->size[0] * r15->data[i27]] = r16->data[r16->size[0] *
        i27];
    }
  ...
  if (3U > 2U + s->size[1]) {
    ...
    i27 = m->size[1];
    if (!(3 <= i27)) {
      emlrtDynamicBoundsCheckR2012b(3, 1, i27, &rd_emlrtBCI, sp);
    }
    ...
    if (!((c_s >= 1) && (c_s <= i28))) {
      emlrtDynamicBoundsCheckR2012b(c_s, 1, i28, &rd_emlrtBCI, sp);
    }
  }
                  ...
                  emxArray_real_T *m)
{
  ...
  i30 = b_s->size[0] * b_s->size[1];
  b_s->size[0] = 1;
  b_s->size[1] = s_idx_0;
  emxEnsureCapacity(sp, (emxArray__common *)b_s, i30, (int32_T)sizeof(real_T),
                    &xb_emlrtRTEI);
  for (i30 = 0; i30 < s_idx_0; i30++) {
    b_s->data[b_s->size[0] * i30] = s->data[i30];
  }
  ...
  /* 'Mymedfilt1:33' n = length(s); */
  /* 'Mymedfilt1:34' m = zeros(w,n+w-1); */
  i30 = b_m->size[0] * b_m->size[1];
  b_m->size[0] = 5;
  b_m->size[1] = (int32_T)(((real_T)b_s->size[1] + 5.0) - 1.0);
  emxEnsureCapacity(sp, (emxArray__common *)b_m, i30, (int32_T)sizeof(real_T),
                    &xb_emlrtRTEI);
  ...
  i30 = b_s->size[1];
  if (!(1 <= i30)) {
    emlrtDynamicBoundsCheckR2012b(1, 1, i30, &pd_emlrtBCI, sp);
  }
  ...
  i31 = b_s->size[1];
  if (!((i31 >= 1) && (i31 <= i30))) {
    emlrtDynamicBoundsCheckR2012b(i31, 1, i30, &qd_emlrtBCI, sp);
  }
  ...
  while (i < 5) {
    ...
    i30 = r17->size[0];
    r17->size[0] = loop_ub;
    emxEnsureCapacity(sp, (emxArray__common *)r17, i30, (int32_T)sizeof(int32_T),
                      &xb_emlrtRTEI);
    for (i30 = 0; i30 < loop_ub; i30++) {
      r17->data[i30] = i30;
    }
    ...
    s_idx_0 = 4 - i;
    i30 = r18->size[0] * r18->size[1];
    r18->size[0] = 1;
    r18->size[1] = (i + b_s->size[1]) + s_idx_0;
    emxEnsureCapacity(sp, (emxArray__common *)r18, i30, (int32_T)sizeof(real_T),
                      &xb_emlrtRTEI);
    for (i30 = 0; i30 < i; i30++) {
      r18->data[r18->size[0] * i30] = c_s;
    }

    loop_ub = b_s->size[1];
    for (i30 = 0; i30 < loop_ub; i30++) {
      r18->data[r18->size[0] * (i30 + i)] = b_s->data[b_s->size[0] * i30];
    }

    for (i30 = 0; i30 < s_idx_0; i30++) {
      r18->data[r18->size[0] * ((i30 + i) + b_s->size[1])] = d_s;
    }
    ...
    loop_ub = r18->size[1];
    for (i30 = 0; i30 < loop_ub; i30++) {
      b_m->data[i + b_m->size[0] * r17->data[i30]] = r18->data[r18->size[0] *
        i30];
    }
  ...
  if (3U > 2U + b_s->size[1]) {
    ...
    i30 = m->size[1];
    if (!(3 <= i30)) {
      emlrtDynamicBoundsCheckR2012b(3, 1, i30, &rd_emlrtBCI, sp);
    }

    i30 = 2;
    i31 = m->size[1];
    s_idx_0 = (int32_T)(2U + b_s->size[1]);
    if (!((s_idx_0 >= 1) && (s_idx_0 <= i31))) {
      emlrtDynamicBoundsCheckR2012b(s_idx_0, 1, i31, &rd_emlrtBCI, sp);
    }
  }

  emxFree_real_T(&b_s);
  emxInit_real_T(sp, &c_m, 2, &xb_emlrtRTEI, true);
  i31 = c_m->size[0] * c_m->size[1];
  c_m->size[0] = 1;
  c_m->size[1] = s_idx_0 - i30;
  emxEnsureCapacity(sp, (emxArray__common *)c_m, i31, (int32_T)sizeof(real_T),
                    &xb_emlrtRTEI);
  loop_ub = s_idx_0 - i30;
  for (i31 = 0; i31 < loop_ub; i31++) {
    c_m->data[c_m->size[0] * i31] = m->data[i30 + i31];
  }

  i30 = m->size[0] * m->size[1];
  m->size[0] = 1;
  m->size[1] = c_m->size[1];
  emxEnsureCapacity(sp, (emxArray__common *)m, i30, (int32_T)sizeof(real_T),
                    &xb_emlrtRTEI);
  loop_ub = c_m->size[1];
  for (i30 = 0; i30 < loop_ub; i30++) {
    m->data[m->size[0] * i30] = c_m->data[c_m->size[0] * i30];
  }
