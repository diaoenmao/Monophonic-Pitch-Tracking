...
static emlrtRSInfo oj_emlrtRSI = { 551, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo pj_emlrtRSI = { 582, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo gn_emlrtRSI = { 339, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo hn_emlrtRSI = { 340, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo in_emlrtRSI = { 348, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo jn_emlrtRSI = { 406, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo kn_emlrtRSI = { 408, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo ln_emlrtRSI = { 413, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo mn_emlrtRSI = { 608, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo nn_emlrtRSI = { 610, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRSInfo on_emlrtRSI = { 638, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRTEInfo je_emlrtRTEI = { 1, 20, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRTEInfo se_emlrtRTEI = { 331, 14, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtRTEInfo te_emlrtRTEI = { 331, 20, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m" };

static emlrtBCInfo sq_emlrtBCI = { 0, 31, 511, 11, "", "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m", 1 };

static emlrtDCInfo vd_emlrtDCI = { 48, 17, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m", 4 };

static emlrtDCInfo wd_emlrtDCI = { 221, 5, "sortIdx",
  "F:\\MATLAB\\toolbox\\eml\\eml\\+coder\\+internal\\sortIdx.m", 4 };
  ...
  emxArray_int32_T *iwork, emxArray_real_T *xwork)
{
  ...
  if (!((preSortLevel >= 0) && (preSortLevel <= 31))) {
    emlrtDynamicBoundsCheckR2012b(preSortLevel, 0, 31, &sq_emlrtBCI, sp);
  }
...
void sortIdx(const emlrtStack *sp, emxArray_real_T *x, emxArray_int32_T *idx)
{
  ...
  emxInit_real_T1(sp, &b_x, 1, &je_emlrtRTEI, true);
  unnamed_idx_0 = (uint32_T)x->size[0];
  if (!(unnamed_idx_0 > 0U)) {
    emlrtNonNegativeCheckR2012b(0.0, &vd_emlrtDCI, sp);
  }
  ...
  emxInit_real_T1(&b_st, &xwork, 1, &te_emlrtRTEI, true);
  c_st.site = &kn_emlrtRSI;
  unnamed_idx_0 = (uint32_T)x->size[0];
  if (!(unnamed_idx_0 > 0U)) {
    emlrtNonNegativeCheckR2012b(0.0, &wd_emlrtDCI, &c_st);
  }
