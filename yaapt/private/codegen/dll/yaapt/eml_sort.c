...
static void b_eml_sort(const double x[100], double y[100], int idx[100]);
...
static void b_eml_sort(const double x[100], double y[100], int idx[100])
{
  ...
  memset(&idx0[0], 1, 100U * sizeof(signed char));
  i = 2;
  while (i < 100) {
    i2 = i << 1;
    j = 1;
 ...
 * Return Type  : void
 */
void eml_sort(const double x[100], double y[100], int idx[100])
{
  b_eml_sort(x, y, idx);
}
